...
clean_multi(air_survey,Pollution_Health_Impact)
...
### AQ Analysis
```{r aq-analysis-report, echo=FALSE}
new_column_names <- c("Air_Quality_Issues", "Health_Issues", "Pollution_Sources", "Air_Quality_Changes", 
                      "Vulnerable_Populations", "Awareness_of_PM_and_Ozone", "Sensor_Locations", 
                      "Improvement_Actions", "Alert_Preferences", "Participation_in_Decisions")

# Replace the names of columns 5 to 14
colnames(air_survey)[5:14] <- new_column_names
air_issues<-clean_multi(air_survey,Health_Issues)
