...
participant_geographies <- fread("../ccs-knowledge/ccs-data[papers]/participant_geographies.csv")


air_survey <- read.csv("../ccs-knowledge/ccs-data/air-quality/air_survey.csv")
air_survey <- air_survey %>%
  select(17,5:14) %>%
  filter(!`Member.ID` %in% potential_fakes)
## REPLACE GEOGRAPHY DATA

air_map <- read.csv("../ccs-knowledge/ccs-data/air-quality/air_map.csv")
...
8. **Have you done anything to improve the air quality in your home or neighborhood? If so, what did you do? If not, what prevents you from taking action?** (Long text)
...
svi_tract <- read.csv("../ccs-knowledge/census-data/svi/svi-wi-tract.csv")
...
eji <- read.csv("/../ccs-knowledge/census-data/environmental/eji-wisconsin.csv")
...
#ejscreen <- read.csv("../ccs-knowledge/census-data/environmental/ejm-wisconsin.csv")
...
# Load the shapefile
#wisconsin_blocks <- st_read("../ccs-knowledge/ccs-data/geography/WI_CensusTL_BlockGroups_2020/WI_CensusTL_BlockGoups_2020.shp")
#wisconsin_tract <- st_read("../ccs-knowledge/ccs-data/geography/tl_2018_55_tract/tl_2018_55_tract.shp")
wisconsin_tract <- st_read("../ccs-knowledge/ccs-data/geography/tl_2019_55_tract//tl_2019_55_tract.shp")
