...
vulnerable_q5viz_a <- clean_matrix_eval_viz(vulnerable_q5[which(vulnerable_q5$question==unique(vulnerable_q5$question)[1]),],"vulnerable")
vulnerable_q5viz_b <-  clean_matrix_eval_viz(vulnerable_q5[which(vulnerable_q5$question==unique(vulnerable_q5$question)[2]),],"vulnerable")

# Example usage:
vulnerable_q5_chi_a <- clean_matrix_eval_chi(vulnerable_q5_a)
vulnerable_q5_chi_b <- clean_matrix_eval_chi(vulnerable_q5_b)
