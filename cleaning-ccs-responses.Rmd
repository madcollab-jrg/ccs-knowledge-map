...
title_word_pairs <- unigram_response %>% 
  pairwise_count(unigram, Gender, sort = TRUE, upper = FALSE)
...
legend.pal<-pal
 ...
 color_set_frequency_agree <- data.frame (answer  = c("Agree Strongly","Agree Somewhat","Neutral","Disagree Somewhat","Disagree Strongly"),
                   col = c("#E66101","#FDB863","#F7F7F7","#B2ABD2","#5E3C99")) 

matrix_summary <- merge(matrix_summary,color_set_frequency_agree, by="answer")
# merge colors with dataframe
...
color_set_frequency_awareness <- data.frame (answer  = c("Aware","Not Aware"),
                   col = c("#E66101","#5E3C99"))

matrix_summary <- merge(matrix_summary,color_set_frequency_awareness, by="answer")
# merge colors with dataframe
...
color_set_frequency_informed <- data.frame (answer  = c("Very Informed","Informed","Moderately Informed","Slightly Informed","Not at all Informed"),
                   col = c("#E66101","#FDB863","#F7F7F7","#B2ABD2","#5E3C99"))

matrix_summary <- merge(matrix_summary,color_set_frequency_informed, by="answer")
# merge colors with dataframe
...
color_set_frequency_amount <- data.frame (answer  = c("A lot","A Good Amount","Some","A Little","Nothing"),
                   col = c("#E66101","#FDB863","#F7F7F7","#B2ABD2","#5E3C99"))

matrix_summary <- merge(matrix_summary,color_set_frequency_amount, by="answer")
# merge colors with dataframe
...
color_set_frequency_binary <- data.frame (answer  = c("Yes","No"),
                   col = c("#E66101","#5E3C99"))

matrix_summary <- merge(matrix_summary,color_set_frequency_binary, by="answer")
# merge colors with dataframe
...
legend.pal<-pal
 ...
 color_set_frequency_importance <- data.frame (answer  = c("Extremely Unimportant","Very Unimportant","Somewhat Unimportant","Neither Important nor Unimportant","Somewhat 
                                                           Important","Very Important","Extremely Important"),col = 
                                               c("#E66101","#FDB863","#FAE9D6","#F7F7F7","#B2ABD2","#6753D7","#3F009E")) 

matrix_summary <- merge(matrix_summary,color_set_frequency_importance, by="answer")
# merge colors with dataframe
