...
home_tab_body <- function() {
  fluidRow(
    ...
    column(
      6,
      img(src = "assets/home-bg.jpg", width = "100%", height = 400, style = "object-fit: cover") # Replace with your image path
    )
  )
}
...
about_tab_body <- function() {
  fluidRow(
    ...
    column(
      ...
      p("Ability decrease armor bonus character coup de grace cowering critical roll death attack dexterity fear aura fighter healing subschool monk monstrous humanoid type pattern subschool prone reptilian subtype rounding spell immunity spell resistance square teleportation subschool turn resistance turned turning damage undeath domain.", class = "page-para"),
...
info_tab_body <- function() {
  fluidRow(
    ...
    column(
      ...
      p("Ability decrease armor bonus character coup de grace cowering critical roll death attack dexterity fear aura fighter healing subschool monk monstrous humanoid type pattern subschool prone reptilian subtype rounding spell immunity spell resistance square teleportation subschool turn resistance turned turning damage undeath domain.", class = "page-para"),
      p("You can view a list of datasets here: Curated Data", class = "page-para"),
      h2("Computing Representativeness", class = "page-subtitle"),
      p("Ability decrease armor bonus character coup de grace cowering critical roll death attack dexterity fear aura fighter healing subschool monk monstrous humanoid type pattern subschool prone reptilian subtype rounding spell immunity spell resistance square teleportation subschool turn resistance turned turning damage undeath domain.", class = "page-para"),
...
avail_data_tab_body <- function() {
  fluidRow(
    ...
    column(
      ...
      h2("About the CCS Knowledge Map Surveys", class = "page-subtitle"),
      p("Ability decrease armor bonus character coup de grace cowering critical roll death attack dexterity fear aura fighter healing subschool monk monstrous humanoid type pattern subschool prone reptilian subtype rounding spell immunity spell resistance square teleportation subschool turn resistance turned turning damage undeath domain.", class = "page-para"),
      p("Select a survey on the right to view the description and questions.", class = "page-para"),
    ),
    column(
      7,
      accordion(
...
#     p(
#       "Since summer 2022, our team has conducted three in-person community forums, as well as created a digital engagement",
...
#     p(
#       "The app was developed using RShiny, the code is open source and available on GitHub -",
...
#   fluidPage(
#     style = "font-size: 1.8rem; text-align: justify;",
#     h1("SURVEYS"),
#     h2("Digital Surveys"),
