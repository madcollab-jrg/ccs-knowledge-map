...
censuscongress_genderedu_white = get_acs(
...
censuscongress_genderedu_white <- censuscongress_genderedu_white %>% select(-contains("C15002A"))


censuscongress_genderedu_black = get_acs(
  geography = "congressional district",
  year = 2019,
  state = "Wisconsin",
...
censuscongress_genderedu_black <- censuscongress_genderedu_black %>% select(-contains("C15002B"))


censuscongress_genderedu_aian = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_genderedu_aian <- censuscongress_genderedu_aian %>% select(-contains("C15002C"))


censuscongress_genderedu_asian = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_genderedu_asian <- censuscongress_genderedu_asian %>% select(-contains("C15002D"))


censuscongress_genderedu_nhpi = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_genderedu_nhpi <- censuscongress_genderedu_nhpi %>% select(-contains("C15002E"))


censuscongress_genderedu_other = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_genderedu_other <- censuscongress_genderedu_other %>% select(-contains("C15002F"))


censuscongress_genderedu_mixed = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_genderedu_mixed <- censuscongress_genderedu_mixed %>% select(-contains("C15002G"))


censuscongress_genderedu_white_nothispanic = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_genderedu_white_nothispanic <- censuscongress_genderedu_white_nothispanic %>% select(-contains("C15002H"))


censuscongress_genderedu_hispanic = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_genderedu_hispanic <- censuscongress_genderedu_hispanic %>% select(-contains("C15002I"))


# Merge all datasets above
censuscongress_genderedu <- censuscongress_genderedu_white %>%
  left_join(censuscongress_genderedu_black, by='GEOID') %>%
  left_join(censuscongress_genderedu_aian, by='GEOID') %>%
  left_join(censuscongress_genderedu_asian, by='GEOID') %>%
  left_join(censuscongress_genderedu_nhpi, by='GEOID') %>%
  left_join(censuscongress_genderedu_other, by='GEOID') %>%
  left_join(censuscongress_genderedu_mixed, by='GEOID') %>%
  left_join(censuscongress_genderedu_white_nothispanic, by='GEOID') %>%
  left_join(censuscongress_genderedu_hispanic, by='GEOID')

names(censuscongress_genderedu)[2] <- "full_geoid"  

censuscongress_genderedu <- censuscongress_genderedu %>% select(-contains("NAME"))
...
censusstatelegislative_upper_genderedu_white = get_acs(
...
censusstatelegislative_upper_genderedu_white <- censusstatelegislative_upper_genderedu_white %>% select(-contains("C15002A"))


censusstatelegislative_upper_genderedu_black = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,
  state = "Wisconsin",
  variables = c(male_black_total = "C15002B_002E", 
...
censusstatelegislative_upper_genderedu_black <- censusstatelegislative_upper_genderedu_black %>% select(-contains("C15002B"))


censusstatelegislative_upper_genderedu_aian = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_aian_total = "C15002C_002E", 
                male_aian_less_hs = "C15002C_003E",
...
censusstatelegislative_upper_genderedu_aian <- censusstatelegislative_upper_genderedu_aian %>% select(-contains("C15002C"))


censusstatelegislative_upper_genderedu_asian = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_asian_total = "C15002D_002E", 
                male_asian_less_hs = "C15002D_003E",
...
censusstatelegislative_upper_genderedu_asian <- censusstatelegislative_upper_genderedu_asian %>% select(-contains("C15002D"))


censusstatelegislative_upper_genderedu_nhpi = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_nhpi_total = "C15002E_002E", 
                male_nhpi_less_hs = "C15002E_003E",
...
censusstatelegislative_upper_genderedu_nhpi <- censusstatelegislative_upper_genderedu_nhpi %>% select(-contains("C15002E"))


censusstatelegislative_upper_genderedu_other = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_other_total = "C15002F_002E", 
                male_other_less_hs = "C15002F_003E",
...
censusstatelegislative_upper_genderedu_other <- censusstatelegislative_upper_genderedu_other %>% select(-contains("C15002F"))


censusstatelegislative_upper_genderedu_mixed = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_mixed_total = "C15002G_002E", 
                male_mixed_less_hs = "C15002G_003E",
...
censusstatelegislative_upper_genderedu_mixed <- censusstatelegislative_upper_genderedu_mixed %>% select(-contains("C15002G"))


censusstatelegislative_upper_genderedu_white_nothispanic = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_w_nothisp_total = "C15002H_002E", 
                male_w_nothisp_less_hs = "C15002H_003E",
...
censusstatelegislative_upper_genderedu_white_nothispanic <- censusstatelegislative_upper_genderedu_white_nothispanic %>% select(-contains("C15002H"))


censusstatelegislative_upper_genderedu_hispanic = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_hisp_total = "C15002I_002E", 
                male_hisp_less_hs = "C15002I_003E",
...
censusstatelegislative_upper_genderedu_hispanic <- censusstatelegislative_upper_genderedu_hispanic %>% select(-contains("C15002I"))


# Merge all datasets above
censusstatelegislative_upper_genderedu <- censusstatelegislative_upper_genderedu_white %>%
  left_join(censusstatelegislative_upper_genderedu_black, by='GEOID') %>%
  left_join(censusstatelegislative_upper_genderedu_aian, by='GEOID') %>%
  left_join(censusstatelegislative_upper_genderedu_asian, by='GEOID') %>%
  left_join(censusstatelegislative_upper_genderedu_nhpi, by='GEOID') %>%
  left_join(censusstatelegislative_upper_genderedu_other, by='GEOID') %>%
  left_join(censusstatelegislative_upper_genderedu_mixed, by='GEOID') %>%
  left_join(censusstatelegislative_upper_genderedu_white_nothispanic, by='GEOID') %>%
  left_join(censusstatelegislative_upper_genderedu_hispanic, by='GEOID')

names(censusstatelegislative_upper_genderedu)[2] <- "full_geoid"  

censusstatelegislative_upper_genderedu <- censusstatelegislative_upper_genderedu %>% select(-contains("NAME"))
...
censusstatelegislative_lower_genderedu_white = get_acs(
...
censusstatelegislative_lower_genderedu_white <- censusstatelegislative_lower_genderedu_white %>% select(-contains("C15002A"))


censusstatelegislative_lower_genderedu_black = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,
  state = "Wisconsin",
  variables = c(male_black_total = "C15002B_002E", 
...
censusstatelegislative_lower_genderedu_black <- censusstatelegislative_lower_genderedu_black %>% select(-contains("C15002B"))


censusstatelegislative_lower_genderedu_aian = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_aian_total = "C15002C_002E", 
                male_aian_less_hs = "C15002C_003E",
...
censusstatelegislative_lower_genderedu_aian <- censusstatelegislative_lower_genderedu_aian %>% select(-contains("C15002C"))


censusstatelegislative_lower_genderedu_asian = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_asian_total = "C15002D_002E", 
                male_asian_less_hs = "C15002D_003E",
...
censusstatelegislative_lower_genderedu_asian <- censusstatelegislative_lower_genderedu_asian %>% select(-contains("C15002D"))


censusstatelegislative_lower_genderedu_nhpi = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_nhpi_total = "C15002E_002E", 
                male_nhpi_less_hs = "C15002E_003E",
...
censusstatelegislative_lower_genderedu_nhpi <- censusstatelegislative_lower_genderedu_nhpi %>% select(-contains("C15002E"))


censusstatelegislative_lower_genderedu_other = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_other_total = "C15002F_002E", 
                male_other_less_hs = "C15002F_003E",
...
censusstatelegislative_lower_genderedu_other <- censusstatelegislative_lower_genderedu_other %>% select(-contains("C15002F"))


censusstatelegislative_lower_genderedu_mixed = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_mixed_total = "C15002G_002E", 
                male_mixed_less_hs = "C15002G_003E",
...
censusstatelegislative_lower_genderedu_mixed <- censusstatelegislative_lower_genderedu_mixed %>% select(-contains("C15002G"))


censusstatelegislative_lower_genderedu_white_nothispanic = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_w_nothisp_total = "C15002H_002E", 
                male_w_nothisp_less_hs = "C15002H_003E",
...
censusstatelegislative_lower_genderedu_white_nothispanic <- censusstatelegislative_lower_genderedu_white_nothispanic %>% select(-contains("C15002H"))


censusstatelegislative_lower_genderedu_hispanic = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_hisp_total = "C15002I_002E", 
                male_hisp_less_hs = "C15002I_003E",
...
censusstatelegislative_lower_genderedu_hispanic <- censusstatelegislative_lower_genderedu_hispanic %>% select(-contains("C15002I"))


# Merge all datasets above
censusstatelegislative_lower_genderedu <- censusstatelegislative_lower_genderedu_white %>%
  left_join(censusstatelegislative_lower_genderedu_black, by='GEOID') %>%
  left_join(censusstatelegislative_lower_genderedu_aian, by='GEOID') %>%
  left_join(censusstatelegislative_lower_genderedu_asian, by='GEOID') %>%
  left_join(censusstatelegislative_lower_genderedu_nhpi, by='GEOID') %>%
  left_join(censusstatelegislative_lower_genderedu_other, by='GEOID') %>%
  left_join(censusstatelegislative_lower_genderedu_mixed, by='GEOID') %>%
  left_join(censusstatelegislative_lower_genderedu_white_nothispanic, by='GEOID') %>%
  left_join(censusstatelegislative_lower_genderedu_hispanic, by='GEOID')

names(censusstatelegislative_lower_genderedu)[2] <- "full_geoid"  

censusstatelegislative_lower_genderedu <- censusstatelegislative_lower_genderedu %>% select(-contains("NAME"))
...
censuszip_genderedu_white = get_acs(
  geography = "zcta",
  year = 2019,
  state = "Wisconsin",
  variables = c(male_white_total = "C15002A_002E", 
...
censuszip_genderedu_white <- censuszip_genderedu_white %>% select(-contains("C15002A"))


censuszip_genderedu_black = get_acs(
  geography = "zcta",
  year = 2019,
  state = "Wisconsin",
  variables = c(male_black_total = "C15002B_002E", 
...
censuszip_genderedu_black <- censuszip_genderedu_black %>% select(-contains("C15002B"))


censuszip_genderedu_aian = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_aian_total = "C15002C_002E", 
                male_aian_less_hs = "C15002C_003E",
...
censuszip_genderedu_aian <- censuszip_genderedu_aian %>% select(-contains("C15002C"))


censuszip_genderedu_asian = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_asian_total = "C15002D_002E", 
                male_asian_less_hs = "C15002D_003E",
...
censuszip_genderedu_asian <- censuszip_genderedu_asian %>% select(-contains("C15002D"))


censuszip_genderedu_nhpi = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_nhpi_total = "C15002E_002E", 
                male_nhpi_less_hs = "C15002E_003E",
...
censuszip_genderedu_nhpi <- censuszip_genderedu_nhpi %>% select(-contains("C15002E"))


censuszip_genderedu_other = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_other_total = "C15002F_002E", 
                male_other_less_hs = "C15002F_003E",
...
censuszip_genderedu_other <- censuszip_genderedu_other %>% select(-contains("C15002F"))


censuszip_genderedu_mixed = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_mixed_total = "C15002G_002E", 
                male_mixed_less_hs = "C15002G_003E",
...
censuszip_genderedu_mixed <- censuszip_genderedu_mixed %>% select(-contains("C15002G"))


censuszip_genderedu_white_nothispanic = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_w_nothisp_total = "C15002H_002E", 
                male_w_nothisp_less_hs = "C15002H_003E",
...
censuszip_genderedu_white_nothispanic <- censuszip_genderedu_white_nothispanic %>% select(-contains("C15002H"))


censuszip_genderedu_hispanic = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_hisp_total = "C15002I_002E", 
                male_hisp_less_hs = "C15002I_003E",
...
censuszip_genderedu_hispanic <- censuszip_genderedu_hispanic %>% select(-contains("C15002I"))


# Merge all datasets above
censuszip_genderedu <- censuszip_genderedu_white %>%
  left_join(censuszip_genderedu_black, by='GEOID') %>%
  left_join(censuszip_genderedu_aian, by='GEOID') %>%
  left_join(censuszip_genderedu_asian, by='GEOID') %>%
  left_join(censuszip_genderedu_nhpi, by='GEOID') %>%
  left_join(censuszip_genderedu_other, by='GEOID') %>%
  left_join(censuszip_genderedu_mixed, by='GEOID') %>%
  left_join(censuszip_genderedu_white_nothispanic, by='GEOID') %>%
  left_join(censuszip_genderedu_hispanic, by='GEOID')

names(censuszip_genderedu)[2] <- "full_geoid"  

censuszip_genderedu <- censuszip_genderedu %>% select(-contains("NAME"))
...
############# congressional district ############# 
censuscongress_age_white = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  variables = c(
...
censuscongress_age_white <- censuscongress_age_white %>% select(-contains("B01001"))


censuscongress_age_black = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_age_black <- censuscongress_age_black %>% select(-contains("B01001"))

censuscongress_age_aian = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_age_aian <- censuscongress_age_aian %>% select(-contains("B01001"))

censuscongress_age_asian = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_age_asian <- censuscongress_age_asian %>% select(-contains("B01001"))

censuscongress_age_nhpi = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  variables = c(
...
censuscongress_age_nhpi <- censuscongress_age_nhpi %>% select(-contains("B01001"))

censuscongress_age_other = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_age_other <- censuscongress_age_other %>% select(-contains("B01001"))

censuscongress_age_mixed = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_age_mixed <- censuscongress_age_mixed %>% select(-contains("B01001"))



censuscongress_age_white_nothispanic = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_age_white_nothispanic <- censuscongress_age_white_nothispanic %>% select(-contains("B01001"))


censuscongress_age_hispanic = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
...
censuscongress_age_hispanic <- censuscongress_age_hispanic %>% select(-contains("B01001"))

# Merge all datasets above
censuscongress_age<- censuscongress_age_white %>%
  left_join(censuscongress_age_black, by='GEOID') %>%
  left_join(censuscongress_age_aian, by='GEOID') %>%
  left_join(censuscongress_age_asian, by='GEOID') %>%
  left_join(censuscongress_age_nhpi, by='GEOID') %>%
  left_join(censuscongress_age_other, by='GEOID') %>%
  left_join(censuscongress_age_mixed, by='GEOID') %>%
  left_join(censuscongress_age_white_nothispanic, by='GEOID') %>%
  left_join(censuscongress_age_hispanic, by='GEOID')

names(censuscongress_age)[2] <- "full_geoid"  

censuscongress_age <- censuscongress_age %>% select(-contains("NAME"))
...
censusstatelegislative_upper_age_white = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(
    male_white_age18to19 = "B01001A_007E", 
...
censusstatelegislative_upper_age_white <- censusstatelegislative_upper_age_white %>% select(-contains("B01001"))


censusstatelegislative_upper_age_black = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_black_age18to19 = "B01001B_007E", 
                male_black_age20to24 = "B01001B_008E",
...
censusstatelegislative_upper_age_black <- censusstatelegislative_upper_age_black %>% select(-contains("B01001"))

censusstatelegislative_upper_age_aian = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_aian_age18to19 = "B01001B_007E", 
                male_aian_age20to24 = "B01001B_008E",
...
censusstatelegislative_upper_age_aian <- censusstatelegislative_upper_age_aian %>% select(-contains("B01001"))

censusstatelegislative_upper_age_asian = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_asian_age18to19 = "B01001D_007E", 
                male_asian_age20to24 = "B01001D_008E",
...
censusstatelegislative_upper_age_asian <- censusstatelegislative_upper_age_asian %>% select(-contains("B01001"))

censusstatelegislative_upper_age_nhpi = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(
    male_nhpi_age18to19 = "B01001E_007E", 
...
censusstatelegislative_upper_age_nhpi <- censusstatelegislative_upper_age_nhpi %>% select(-contains("B01001"))

censusstatelegislative_upper_age_other = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_other_age18to19 = "B01001F_007E", 
                male_other_age20to24 = "B01001F_008E",
...
censusstatelegislative_upper_age_other <- censusstatelegislative_upper_age_other %>% select(-contains("B01001"))

censusstatelegislative_upper_age_mixed = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_mixed_age18to19 = "B01001G_007E", 
                male_mixed_age20to24 = "B01001G_008E",
...
censusstatelegislative_upper_age_mixed <- censusstatelegislative_upper_age_mixed %>% select(-contains("B01001"))



censusstatelegislative_upper_age_white_nothispanic = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_w_nothisp_age18to19 = "B01001H_007E", 
                male_w_nothisp_age20to24 = "B01001H_008E",
...
censusstatelegislative_upper_age_white_nothispanic <- censusstatelegislative_upper_age_white_nothispanic %>% select(-contains("B01001"))


censusstatelegislative_upper_age_hispanic = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_hisp_age18to19 = "B01001I_007E", 
                male_hisp_age20to24 = "B01001I_008E",
...
censusstatelegislative_upper_age_hispanic <- censusstatelegislative_upper_age_hispanic %>% select(-contains("B01001"))

# Merge all datasets above
censusstatelegislative_upper_age<- censusstatelegislative_upper_age_white %>%
  left_join(censusstatelegislative_upper_age_black, by='GEOID') %>%
  left_join(censusstatelegislative_upper_age_aian, by='GEOID') %>%
  left_join(censusstatelegislative_upper_age_asian, by='GEOID') %>%
  left_join(censusstatelegislative_upper_age_nhpi, by='GEOID') %>%
  left_join(censusstatelegislative_upper_age_other, by='GEOID') %>%
  left_join(censusstatelegislative_upper_age_mixed, by='GEOID') %>%
  left_join(censusstatelegislative_upper_age_white_nothispanic, by='GEOID') %>%
  left_join(censusstatelegislative_upper_age_hispanic, by='GEOID')

names(censusstatelegislative_upper_age)[2] <- "full_geoid"  

censusstatelegislative_upper_age <- censusstatelegislative_upper_age %>% select(-contains("NAME"))
...
censusstatelegislative_lower_age_white = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(
    male_white_age18to19 = "B01001A_007E", 
...
censusstatelegislative_lower_age_white <- censusstatelegislative_lower_age_white %>% select(-contains("B01001"))


censusstatelegislative_lower_age_black = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_black_age18to19 = "B01001B_007E", 
                male_black_age20to24 = "B01001B_008E",
...
censusstatelegislative_lower_age_black <- censusstatelegislative_lower_age_black %>% select(-contains("B01001"))

censusstatelegislative_lower_age_aian = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_aian_age18to19 = "B01001B_007E", 
                male_aian_age20to24 = "B01001B_008E",
...
censusstatelegislative_lower_age_aian <- censusstatelegislative_lower_age_aian %>% select(-contains("B01001"))

censusstatelegislative_lower_age_asian = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_asian_age18to19 = "B01001D_007E", 
                male_asian_age20to24 = "B01001D_008E",
...
censusstatelegislative_lower_age_asian <- censusstatelegislative_lower_age_asian %>% select(-contains("B01001"))

censusstatelegislative_lower_age_nhpi = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(
    male_nhpi_age18to19 = "B01001E_007E", 
...
censusstatelegislative_lower_age_nhpi <- censusstatelegislative_lower_age_nhpi %>% select(-contains("B01001"))

censusstatelegislative_lower_age_other = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_other_age18to19 = "B01001F_007E", 
                male_other_age20to24 = "B01001F_008E",
...
censusstatelegislative_lower_age_other <- censusstatelegislative_lower_age_other %>% select(-contains("B01001"))

censusstatelegislative_lower_age_mixed = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_mixed_age18to19 = "B01001G_007E", 
                male_mixed_age20to24 = "B01001G_008E",
...
censusstatelegislative_lower_age_mixed <- censusstatelegislative_lower_age_mixed %>% select(-contains("B01001"))



censusstatelegislative_lower_age_white_nothispanic = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_w_nothisp_age18to19 = "B01001H_007E", 
                male_w_nothisp_age20to24 = "B01001H_008E",
...
censusstatelegislative_lower_age_white_nothispanic <- censusstatelegislative_lower_age_white_nothispanic %>% select(-contains("B01001"))


censusstatelegislative_lower_age_hispanic = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(male_hisp_age18to19 = "B01001I_007E", 
                male_hisp_age20to24 = "B01001I_008E",
...
censusstatelegislative_lower_age_hispanic <- censusstatelegislative_lower_age_hispanic %>% select(-contains("B01001"))

# Merge all datasets above
censusstatelegislative_lower_age<- censusstatelegislative_lower_age_white %>%
  left_join(censusstatelegislative_lower_age_black, by='GEOID') %>%
  left_join(censusstatelegislative_lower_age_aian, by='GEOID') %>%
  left_join(censusstatelegislative_lower_age_asian, by='GEOID') %>%
  left_join(censusstatelegislative_lower_age_nhpi, by='GEOID') %>%
  left_join(censusstatelegislative_lower_age_other, by='GEOID') %>%
  left_join(censusstatelegislative_lower_age_mixed, by='GEOID') %>%
  left_join(censusstatelegislative_lower_age_white_nothispanic, by='GEOID') %>%
  left_join(censusstatelegislative_lower_age_hispanic, by='GEOID')

names(censusstatelegislative_lower_age)[2] <- "full_geoid"  

censusstatelegislative_lower_age <- censusstatelegislative_lower_age %>% select(-contains("NAME"))
...
censuszip_age_white <- censuszip_age_white %>% select(-contains("B01001"))


censuszip_age_black = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_black_age18to19 = "B01001B_007E", 
                male_black_age20to24 = "B01001B_008E",
...
censuszip_age_black <- censuszip_age_black %>% select(-contains("B01001"))

censuszip_age_aian = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_aian_age18to19 = "B01001B_007E", 
                male_aian_age20to24 = "B01001B_008E",
...
censuszip_age_aian <- censuszip_age_aian %>% select(-contains("B01001"))

censuszip_age_asian = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_asian_age18to19 = "B01001D_007E", 
                male_asian_age20to24 = "B01001D_008E",
...
censuszip_age_asian <- censuszip_age_asian %>% select(-contains("B01001"))

censuszip_age_nhpi = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(
    male_nhpi_age18to19 = "B01001E_007E", 
...
censuszip_age_nhpi <- censuszip_age_nhpi %>% select(-contains("B01001"))

censuszip_age_other = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_other_age18to19 = "B01001F_007E", 
                male_other_age20to24 = "B01001F_008E",
...
censuszip_age_other <- censuszip_age_other %>% select(-contains("B01001"))

censuszip_age_mixed = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_mixed_age18to19 = "B01001G_007E", 
                male_mixed_age20to24 = "B01001G_008E",
...
censuszip_age_mixed <- censuszip_age_mixed %>% select(-contains("B01001"))



censuszip_age_white_nothispanic = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_w_nothisp_age18to19 = "B01001H_007E", 
                male_w_nothisp_age20to24 = "B01001H_008E",
...
censuszip_age_white_nothispanic <- censuszip_age_white_nothispanic %>% select(-contains("B01001"))


censuszip_age_hispanic = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(male_hisp_age18to19 = "B01001I_007E", 
                male_hisp_age20to24 = "B01001I_008E",
...
censuszip_age_hispanic <- censuszip_age_hispanic %>% select(-contains("B01001"))

# Merge all datasets above
censuszip_age<- censuszip_age_white %>%
  left_join(censuszip_age_black, by='GEOID') %>%
  left_join(censuszip_age_aian, by='GEOID') %>%
  left_join(censuszip_age_asian, by='GEOID') %>%
  left_join(censuszip_age_nhpi, by='GEOID') %>%
  left_join(censuszip_age_other, by='GEOID') %>%
  left_join(censuszip_age_mixed, by='GEOID') %>%
  left_join(censuszip_age_white_nothispanic, by='GEOID') %>%
  left_join(censuszip_age_hispanic, by='GEOID')

names(censuszip_age)[2] <- "full_geoid"  

censuszip_age <- censuszip_age %>% select(-contains("NAME"))
...
censuscongress_raceeth = get_decennial(
  geography = "congressional district",
  state = "WI",
...
censusstatelegislative_upper_raceeth = get_decennial(
  geography = "state legislative district (upper chamber)",
  state = "WI",
  variables = desired_raceeth, 
  summary_var = "P2_001N", 
...
write.csv(censusstatelegislative_upper_raceeth,"/Volumes/cbjackson2/ccs-knowledge/census-data/census/state_upper/state_upper_raceeth.csv")

############# state legislative district (lower chamber) ############# 

censusstatelegislative_lower_raceeth = get_decennial(
  geography = "state legislative district (lower chamber)",
  state = "WI",
  variables = desired_raceeth, 
  summary_var = "P2_001N", 
...
write.csv(censusstatelegislative_lower_raceeth,"/Volumes/cbjackson2/ccs-knowledge/census-data/census/state_lower/state_lower_raceeth.csv")
...
censuscongress_income_white = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_white <- censuscongress_income_white %>% select(-contains("B19001A"))


censuscongress_income_black = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_black <- censuscongress_income_black %>% select(-contains("B19001"))


censuscongress_income_aian = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_aian <- censuscongress_income_aian %>% select(-contains("B19001"))


censuscongress_income_asian = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_asian <- censuscongress_income_asian %>% select(-contains("B19001"))


censuscongress_income_nhpi = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_nhpi <- censuscongress_income_nhpi %>% select(-contains("B19001"))


censuscongress_income_other = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_other <- censuscongress_income_other %>% select(-contains("B19001"))


censuscongress_income_mixed = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_mixed <- censuscongress_income_mixed %>% select(-contains("B19001"))


censuscongress_income_white_nothispanic = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_white_nothispanic <- censuscongress_income_white_nothispanic %>% select(-contains("B19001"))

censuscongress_income_hispanic = get_acs(
  geography = "congressional district",
  year = 2019,   state = "Wisconsin",
  ...
  select(-ends_with("M"))
censuscongress_income_hispanic <- censuscongress_income_hispanic %>% select(-contains("B19001"))


censuscongress_income <- censuscongress_income_white %>%
  left_join(censuscongress_income_black, by='GEOID') %>%
  left_join(censuscongress_income_aian, by='GEOID') %>%
  left_join(censuscongress_income_asian, by='GEOID') %>%
  left_join(censuscongress_income_nhpi, by='GEOID') %>%
  left_join(censuscongress_income_other, by='GEOID') %>%
  left_join(censuscongress_income_mixed, by='GEOID') %>%
  left_join(censuscongress_income_white_nothispanic, by='GEOID') %>%
  left_join(censuscongress_income_hispanic, by='GEOID')

names(censuscongress_income)[2] <- "full_geoid"  

censuscongress_income <- censuscongress_income %>% select(-contains("NAME"))
...
censusstatelegislative_upper_income_white = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(white_total = "B19001A_001",
                white_less10k = "B19001A_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_white <- censusstatelegislative_upper_income_white %>% select(-contains("B19001A"))

censusstatelegislative_upper_income_black = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(black_total = "B19001B_001",
                black_less10k = "B19001B_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_black <- censusstatelegislative_upper_income_black %>% select(-contains("B19001"))


censusstatelegislative_upper_income_aian = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(aian_total = "B19001C_001",
                aian_less10k = "B19001C_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_aian <- censusstatelegislative_upper_income_aian %>% select(-contains("B19001"))


censusstatelegislative_upper_income_asian = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(asian_total = "B19001D_001",
                asian_less10k = "B19001D_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_asian <- censusstatelegislative_upper_income_asian %>% select(-contains("B19001"))


censusstatelegislative_upper_income_nhpi = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(nhpi_total = "B19001E_001",
                nhpi_less10k = "B19001E_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_nhpi <- censusstatelegislative_upper_income_nhpi %>% select(-contains("B19001"))


censusstatelegislative_upper_income_other = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(other_total = "B19001F_001",
                other_less10k = "B19001F_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_other <- censusstatelegislative_upper_income_other %>% select(-contains("B19001"))


censusstatelegislative_upper_income_mixed = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(mixed_total = "B19001G_001",
                mixed_less10k = "B19001G_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_mixed <- censusstatelegislative_upper_income_mixed %>% select(-contains("B19001"))


censusstatelegislative_upper_income_white_nothispanic = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(w_nothisp_total = "B19001H_001",
                w_nothisp_less10k = "B19001H_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_white_nothispanic <- censusstatelegislative_upper_income_white_nothispanic %>% select(-contains("B19001"))

censusstatelegislative_upper_income_hispanic = get_acs(
  geography = "state legislative district (upper chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(hisp_total = "B19001I_001",
                hisp_less10k = "B19001I_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_upper_income_hispanic <- censusstatelegislative_upper_income_hispanic %>% select(-contains("B19001"))


censusstatelegislative_upper_income <- censusstatelegislative_upper_income_white %>%
  left_join(censusstatelegislative_upper_income_black, by='GEOID') %>%
  left_join(censusstatelegislative_upper_income_aian, by='GEOID') %>%
  left_join(censusstatelegislative_upper_income_asian, by='GEOID') %>%
  left_join(censusstatelegislative_upper_income_nhpi, by='GEOID') %>%
  left_join(censusstatelegislative_upper_income_other, by='GEOID') %>%
  left_join(censusstatelegislative_upper_income_mixed, by='GEOID') %>%
  left_join(censusstatelegislative_upper_income_white_nothispanic, by='GEOID') %>%
  left_join(censusstatelegislative_upper_income_hispanic, by='GEOID')

names(censusstatelegislative_upper_income)[2] <- "full_geoid"  

censusstatelegislative_upper_income <- censusstatelegislative_upper_income %>% select(-contains("NAME"))
...
censusstatelegislative_lower_income_white = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(white_total = "B19001A_001",
                white_less10k = "B19001A_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_white <- censusstatelegislative_lower_income_white %>% select(-contains("B19001A"))


censusstatelegislative_lower_income_black = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(black_total = "B19001B_001",
                black_less10k = "B19001B_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_black <- censusstatelegislative_lower_income_black %>% select(-contains("B19001"))


censusstatelegislative_lower_income_aian = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(aian_total = "B19001C_001",
                aian_less10k = "B19001C_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_aian <- censusstatelegislative_lower_income_aian %>% select(-contains("B19001"))


censusstatelegislative_lower_income_asian = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(asian_total = "B19001D_001",
                asian_less10k = "B19001D_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_asian <- censusstatelegislative_lower_income_asian %>% select(-contains("B19001"))


censusstatelegislative_lower_income_nhpi = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(nhpi_total = "B19001E_001",
                nhpi_less10k = "B19001E_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_nhpi <- censusstatelegislative_lower_income_nhpi %>% select(-contains("B19001"))


censusstatelegislative_lower_income_other = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(other_total = "B19001F_001",
                other_less10k = "B19001F_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_other <- censusstatelegislative_lower_income_other %>% select(-contains("B19001"))


censusstatelegislative_lower_income_mixed = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(mixed_total = "B19001G_001",
                mixed_less10k = "B19001G_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_mixed <- censusstatelegislative_lower_income_mixed %>% select(-contains("B19001"))


censusstatelegislative_lower_income_white_nothispanic = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(w_nothisp_total = "B19001H_001",
                w_nothisp_less10k = "B19001H_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_white_nothispanic <- censusstatelegislative_lower_income_white_nothispanic %>% select(-contains("B19001"))

censusstatelegislative_lower_income_hispanic = get_acs(
  geography = "state legislative district (lower chamber)",
  year = 2019,   state = "Wisconsin",
  variables = c(hisp_total = "B19001I_001",
                hisp_less10k = "B19001I_002", 
  ...
  select(-ends_with("M"))
censusstatelegislative_lower_income_hispanic <- censusstatelegislative_lower_income_hispanic %>% select(-contains("B19001"))


censusstatelegislative_lower_income <- censusstatelegislative_lower_income_white %>%
  left_join(censusstatelegislative_lower_income_black, by='GEOID') %>%
  left_join(censusstatelegislative_lower_income_aian, by='GEOID') %>%
  left_join(censusstatelegislative_lower_income_asian, by='GEOID') %>%
  left_join(censusstatelegislative_lower_income_nhpi, by='GEOID') %>%
  left_join(censusstatelegislative_lower_income_other, by='GEOID') %>%
  left_join(censusstatelegislative_lower_income_mixed, by='GEOID') %>%
  left_join(censusstatelegislative_lower_income_white_nothispanic, by='GEOID') %>%
  left_join(censusstatelegislative_lower_income_hispanic, by='GEOID')

names(censusstatelegislative_lower_income)[2] <- "full_geoid"  

censusstatelegislative_lower_income <- censusstatelegislative_lower_income %>% select(-contains("NAME"))
...
censuszip_income_white = get_acs(
  geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(white_total = "B19001A_001",
                white_less10k = "B19001A_002", 
  ...
  select(-ends_with("M"))
censuszip_income_white <- censuszip_income_white %>% select(-contains("B19001A"))


censuszip_income_black = get_acs(
   geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(black_total = "B19001B_001",
                black_less10k = "B19001B_002", 
  ...
  select(-ends_with("M"))
censuszip_income_black <- censuszip_income_black %>% select(-contains("B19001"))


censuszip_income_aian = get_acs(
   geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(aian_total = "B19001C_001",
                aian_less10k = "B19001C_002", 
  ...
  select(-ends_with("M"))
censuszip_income_aian <- censuszip_income_aian %>% select(-contains("B19001"))


censuszip_income_asian = get_acs(
   geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(asian_total = "B19001D_001",
                asian_less10k = "B19001D_002", 
  ...
  select(-ends_with("M"))
censuszip_income_asian <- censuszip_income_asian %>% select(-contains("B19001"))


censuszip_income_nhpi = get_acs(
   geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(nhpi_total = "B19001E_001",
                nhpi_less10k = "B19001E_002", 
  ...
  select(-ends_with("M"))
censuszip_income_nhpi <- censuszip_income_nhpi %>% select(-contains("B19001"))


censuszip_income_other = get_acs(
   geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(other_total = "B19001F_001",
                other_less10k = "B19001F_002", 
  ...
  select(-ends_with("M"))
censuszip_income_other <- censuszip_income_other %>% select(-contains("B19001"))


censuszip_income_mixed = get_acs(
   geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(mixed_total = "B19001G_001",
                mixed_less10k = "B19001G_002", 
  ...
  select(-ends_with("M"))
censuszip_income_mixed <- censuszip_income_mixed %>% select(-contains("B19001"))


censuszip_income_white_nothispanic = get_acs(
   geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(w_nothisp_total = "B19001H_001",
                w_nothisp_less10k = "B19001H_002", 
  ...
  select(-ends_with("M"))
censuszip_income_white_nothispanic <- censuszip_income_white_nothispanic %>% select(-contains("B19001"))

censuszip_income_hispanic = get_acs(
   geography = "zcta",
  year = 2019,   state = "Wisconsin",
  variables = c(hisp_total = "B19001I_001",
                hisp_less10k = "B19001I_002", 
  ...
  select(-ends_with("M"))
censuszip_income_hispanic <- censuszip_income_hispanic %>% select(-contains("B19001"))


censuszip_income <- censuszip_income_white %>%
  left_join(censuszip_income_black, by='GEOID') %>%
  left_join(censuszip_income_aian, by='GEOID') %>%
  left_join(censuszip_income_asian, by='GEOID') %>%
  left_join(censuszip_income_nhpi, by='GEOID') %>%
  left_join(censuszip_income_other, by='GEOID') %>%
  left_join(censuszip_income_mixed, by='GEOID') %>%
  left_join(censuszip_income_white_nothispanic, by='GEOID') %>%
  left_join(censuszip_income_hispanic, by='GEOID')

names(censuszip_income)[2] <- "full_geoid"  

censuszip_income <- censuszip_income %>% select(-contains("NAME"))
