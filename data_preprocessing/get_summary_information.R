...
get_summary_statistics = function(survey, census_level, queries, census_code, save = T, fname = ""){
  n = length(queries)
...
for(survey in SURVEYS){
  ...
  for(rep_level in names(census_codes)){
    for(census_code in census_codes[[rep_level]]){
      ...
      get_summary_statistics(survey_dataset, rep_level, queries_to_compile, census_code, save = T, fname = name)
